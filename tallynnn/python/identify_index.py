...
with pysam.FastxFile(args.infile) as fh:
    ...
    for record in fh:
        ...
        for i in m:
            ...
            if os.path.exists('seperate_samples.dir/' + fname + '.gz'):
                read = iotools.open_file('seperate_samples.dir/' + fname + '.gz',"a")
            else:
                read = iotools.open_file('seperate_samples.dir/' +   fname + '.gz',"w")
