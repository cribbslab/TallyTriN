...
htmlhelp_basename = 'tallytrindoc'
...
latex_documents = [
    (master_doc, 'tallytrin.tex', 'tallytrin Documentation',
     'manual'),
]
...
man_pages = [
    (master_doc, 'tallytrin', 'tallytrin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tallytrin', 'tallytrin Documentation',
     author, 'tallytrin', 'One line description of project.',
     'Miscellaneous'),
]
